...
function pdo_get_connection(){
    ...
    $dburl = "mysql:host=localhost;dbname=webhotel;charset=utf8";
    $username = 'root';
    $password = '';
    $conn = new PDO($dburl, $username, $password);
    // PDO là lớp truy xuất cơ sở dữ liệu để làm việc với nhiều loại cơ sở dữ liệu khác nhau
...
function pdo_execute($sql){
    ...
    // còn array_slice trả về một mảng đảo ngược với mảng ban đầu
